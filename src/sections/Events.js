...
const PAST_EVENTS_ENDPOINT = `https://sheets.googleapis.com/v4/spreadsheets/1ynEzX8p1P1wVxqVFl6Ksyf5g2jtqx_AMc-gnZAbv4E8/values/past_events?alt=json&key=${GOOGLE_SHEETS_API_KEY}`;
const UPCOMING_EVENTS_ENDPOINT = `https://sheets.googleapis.com/v4/spreadsheets/1ynEzX8p1P1wVxqVFl6Ksyf5g2jtqx_AMc-gnZAbv4E8/values/upcoming_events?alt=json&key=${GOOGLE_SHEETS_API_KEY}`;
